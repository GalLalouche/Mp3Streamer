// Copy-pasted from https://github.com/elmarx/ts-try/blob/master/src/index.ts, since using this as a proper
// dependency doesn't see the exports properly for some reason.
/**
