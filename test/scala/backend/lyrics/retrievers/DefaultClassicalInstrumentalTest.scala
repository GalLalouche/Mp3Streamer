...
class DefaultClassicalInstrumentalTest extends FreeSpec with ShouldMatchers {
  ...
  private val classicalSong = fakeModelFactory.song(
    filePath="""D:/Media/Music/Classical/Glenn Gould/1955 Goldberg Variations/01 - Aria.flac""")
  ...
  "Non classical file" in {
    val song = fakeModelFactory.song(
      filePath="""D:/Media/Music/Rock/Pop/My Lame Band/01 - My crappy pop song.mp3""")
