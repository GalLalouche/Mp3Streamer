...
class SongGroupsTest extends FreeSpec with AuxSpecs {
  private val song1 = FakeModelFactory.mockSong()
  private val song2 = FakeModelFactory.mockSong()
  private val song3 = FakeModelFactory.mockSong()
  private val song4 = FakeModelFactory.mockSong()
  ...
  "fromSongs" in {
    val song5 = FakeModelFactory.mockSong()
