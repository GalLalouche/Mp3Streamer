...
/**
 * A release group is an proper album, whereas a release is a specific version of said album. A release entity
 * can have different external links than the group entity, which is why we're interested in releases to begin
 * with.
 */
