...
/**
* MusicBrainz is supposed to allow adding Bandcamp lyric links for release groups, which would have been great
* since then one could simply fetch the bandcamp link from the release group external links, which are fetched
* anyway. But they don't.
* However, they *do* allow Bandcamp links in specific releases.
* So this class fetches the external links of the releases, and hopefully something useful will come from
* that.
*/
