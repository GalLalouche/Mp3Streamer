...
trait CachedModelScorer {
  ...
  /**
   * This method should avoid parsing songs. Instead, it should extract the necessary metadata from the file
   * path. This makes it safe to call while traversing a (very large) list of files.
   */
