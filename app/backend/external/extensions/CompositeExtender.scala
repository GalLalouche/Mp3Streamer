...
private[external] class CompositeExtender private(artistExtensions: HostMap[LinkExtender[Artist]], albumExtensions: HostMap[LinkExtender[Album]]) {
  private def auxExtend[R <: Reconcilable](entity: R, e: ExternalLink[R], map: HostMap[LinkExtender[R]]): ExtendedLink[R] =
  ...
  def apply[R <: Reconcilable : Manifest](entity: R, e: ExternalLink[R]): ExtendedLink[R] = {
