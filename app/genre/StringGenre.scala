 ...
 *
 * This class is more flexible, since it only assumes flat and nested genres, and not specific
 * genres. However, this isn't as useful when actually writing business code, e.g., to create
